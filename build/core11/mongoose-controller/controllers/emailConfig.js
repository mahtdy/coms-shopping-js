...
const repository_1 = __importDefault(require("../repositories/emailConfig/repository"));
const controller_1 = __importDefault(require("../controller"));
const mongoose_1 = require("mongoose");
const zod_1 = require("zod");
const repository_2 = __importDefault(require("../repositories/emailLog/repository"));
const emailMessager_1 = __importDefault(require("../../messaging/emailMessager"));
const repository_3 = __importDefault(require("../repositories/emailTemplate/repository"));
class EmailConfigController extends controller_1.default {
    constructor(baseRoute, repo, options) {
        ...
        if (!options.insertSchema) {
            options.insertSchema = zod_1.z.object({
                ...
                config: zod_1.z.any(),
                type: zod_1.z.enum(["smtp", "other"]),
                protocolType: zod_1.z.enum(["TLS", "SSL", "NonSecure"]),
    ...
    async createWithAdmin(data, session) {
        var _a;
        data.maker = (_a = session.admin) === null || _a === void 0 ? void 0 : _a._id;
    ...
    async test(session, id) {
        ...
        try {
            var result = await emailMessager_1.default.sendWithConfig({
                template: "testTemplate",
                receptor: admin === null || admin === void 0 ? void 0 : admin.email,
                parameters: {
                    test: ""
                }
...
var emailConfig = new EmailConfigController("/emailConfig", new repository_1.default(), {});
