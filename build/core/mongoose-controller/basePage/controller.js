...
class BasePageController extends controller_1.default {
    ...
    async publish(data, id, update, admin, ...params) {
        try {
            data.isDraft = false;
...
exports.seoSchema = zod_1.z.object({
    "url": zod_1.z.string(),
    "typeOfUrl": zod_1.z.enum(["withSign", "withoutSign", "custom"]).default("withSign"),
    "id": zod_1.z.any(),
    ...
    robotsConfig: controller_1.default.search.optional()
});
...
exports.basePageZod = zod_1.z.object({
    ...
    wordCount: zod_1.z.coerce.number().int().min(0).default(0)
});
