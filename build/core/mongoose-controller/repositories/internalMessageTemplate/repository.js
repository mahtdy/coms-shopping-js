...
class InternalMessageTemplateRepository extends repository_1.default {
    constructor(options) {
        super(model_1.InternalMessageTemplateModel, options);
...
exports.default = InternalMessageTemplateRepository;
