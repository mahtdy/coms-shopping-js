...
const idGen = new randexp_1.default(IdRegex);
...
BaseController.arrayFromForm = zod_1.z.string().transform((data) => JSON.parse(data));
BaseController.numberFromForm = zod_1.z.string().transform((data) => Number(data));
...
BaseController.id = zod_1.z.string().regex(/^[a-f\d]{24}$/i);
