...
const repository_8 = __importDefault(require("../repositories/fakeComment/repository"));
let ejs = require("ejs");
const sortMap = {
    "oldest": {
        _id: 1
...
class CommentController extends controller_1.default {
    constructor(baseRoute, repo, options) {
        ...
        this.fakeCommentRepo = new repository_8.default();
    }
    initApis() {
        super.initApis();
    }
            ...
            if ((comment === null || comment === void 0 ? void 0 : comment.status) == "confirmed") {
                if (comment === null || comment === void 0 ? void 0 : comment.reply) {
                    ...
                    if (comment.manualId != undefined) {
                        await this.fakeCommentRepo.deleteById(comment.manualId);
                    }
                }
            }
