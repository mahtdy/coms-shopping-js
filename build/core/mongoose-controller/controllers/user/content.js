...
class ContentController extends controller_1.default {
    ...
    async getContents(category, type, language, sortKey, sortOrder, id, page, limit) {
        var _a;
        const contentMap = config_1.default.getConfig("contentMap");
        type = contentMap[type];
        var rep = (_a = contentRegistry_1.default.getInstance().getRegistry(type)) === null || _a === void 0 ? void 0 : _a.repo;
        ...
        let contents = JSON.parse(JSON.stringify(await this.contentRepo.findMany(query, {
            sort
        })));
