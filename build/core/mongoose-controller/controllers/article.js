...
exports.insertSchema = zod_1.z.object({
    ...
    commentShow: zod_1.z.boolean().default(false),
    ...
    resolutionConfig: zod_1.z
        ...
        deletePrevious: zod_1.z.boolean().optional(),
        srcChanged: zod_1.z.boolean().optional()
    })
        .optional(),
...
class ArticleController extends controller_2.BasePageController {
    ...
    async replcaeImage(image, oldImage) {
        var _a, _b;
        try {
            await this.cdn.findCdnFromUrl(oldImage);
            if (((_a = this.cdn.cdn) === null || _a === void 0 ? void 0 : _a.baseDir) == undefined) {
                return {
                    status: 400
                };
            }
            let baseDir = oldImage.replace((_b = this.cdn.cdn) === null || _b === void 0 ? void 0 : _b.baseDir, "");
            image = await fileManager_1.DiskFileManager.downloadFile(image);
    ...
    async proccessInContentImage(files, language, contentNumber, type) {
        var path = files[0].path;
        if (path == undefined) {
            return {
                status: 400,
    ...
    async proccessMainImage(files, language, contentNumber, type) {
        var path = files[0].path;
        if (path == undefined) {
            return {
                status: 400,
        ...
        try {
            return {
                status: 200,
                data: await this.cdn.uploadWithState(files[0].path, (await ArticleController.getPathResolver("image", savePath.path, domainImage["image-addressing"], contentNumber)()) +
                    destinationPath[destinationPath.length - 1]),
            };
        }
        catch (error) {
...
__decorate([
    (0, method_1.Post)("/api/admin/content/image/replace", {
        absolute: true,
    }),
    __param(0, (0, parameters_1.Body)({
        schema: zod_1.z.string(),
...
], ArticleController.prototype, "replcaeImage", null);
__decorate([
    (0, method_1.Post)("/api/admin/in-content/image/", {
        contentType: "multipart/form-data",
        absolute: true,
    }),
    __param(0, (0, parameters_1.Files)({
...
], ArticleController.prototype, "proccessInContentImage", null);
__decorate([
    (0, method_1.Post)("/api/admin/content/main-image/", {
        contentType: "multipart/form-data",
        absolute: true,
    }),
    __param(0, (0, parameters_1.Files)({
...
], ArticleController.prototype, "proccessMainImage", null);
__decorate([
