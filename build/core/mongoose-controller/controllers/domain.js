...
const repository_6 = __importDefault(require("../repositories/fileManagerConfig/repository"));
...
class DomainController extends controller_1.default {
    constructor(baseRoute, repo, options) {
        ...
        this.cdnConfigRepo = new repository_6.default();
...
__decorate([
    (0, method_1.Post)("/local-cdn"),
    __param(0, (0, parameters_1.Body)({
        destination: "id",
        schema: controller_1.default.id
    }))
], DomainController.prototype, "creteLocalCdn", null);
