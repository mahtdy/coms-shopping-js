        ...
        try {
            ...
            let interval = setInterval(async () => {
                ...
                if (d != null) {
                    ...
                    if ((_a = status.p) === null || _a === void 0 ? void 0 : _a.includes("100")) {
                        // co
...
class CDN_Manager {
    ...
    findUrlDirectory(url) {
        ...
        if (this.cdn == undefined)
            return false;
        let directory = url.replace((_a = this.cdn) === null || _a === void 0 ? void 0 : _a.baseDir, "");
    ...
    async unzip(file, directory, options) {
        var _a, _b;
        try {
            console.log("options", (_a = options === null || options === void 0 ? void 0 : options.files) === null || _a === void 0 ? void 0 : _a.length);
            let r = await ((_b = this.cdn) === null || _b === void 0 ? void 0 : _b.unzip(file, directory, options));
