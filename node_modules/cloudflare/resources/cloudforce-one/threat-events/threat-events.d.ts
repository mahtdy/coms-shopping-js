...
export type ThreatEventBulkCreateResponse = Array<ThreatEventBulkCreateResponse.ThreatEventBulkCreateResponseItem>;
export declare namespace ThreatEventBulkCreateResponse {
    interface ThreatEventBulkCreateResponseItem {
        id: number;
        accountId: number;
        attacker: string;
        attackerCountry: string;
